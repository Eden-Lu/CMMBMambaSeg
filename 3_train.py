...
class BraTSTrainer(Trainer):
    def __init__(self, env_type, max_epochs, batch_size, device="cpu", val_every=1, num_gpus=1, logdir="./logs/", master_ip='localhost', master_port=10875, training_script="train.py"):
        ...
        self.model = CMMBMambaSeg(in_chans=4,
                        out_chans=4,
                        depths=[2,2,2,2],
        ...
        self.mse = nn.MSELoss()
        self.train_process = 12    #18
        self.optimizer = torch.optim.SGD(self.model.parameters(), lr=5e-3, weight_decay=3e-5,    # 1e-2,3e-5
